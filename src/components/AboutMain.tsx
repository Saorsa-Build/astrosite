...
import ethanWalker from "@/assets/ethanwalker.jpg";
      ...
      <div className="container max-w-[860px] px-4">
        ...
        <div className="mb-10 rounded-2xl p-8 bg-black/30 backdrop-blur-lg border border-border/30">
          <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
            ...
            {/* Photo card */}
            <div className="mx-auto w-full max-w-[260px] shrink-0 lg:mx-0 border-2 border-white bg-white p-1 self-start lg:self-center">
              <img
                src={ethanWalker.src}
                alt="Ethan Walker"
                className="pointer-events-none w-full object-cover border border-neutral-200 aspect-square"
              />
